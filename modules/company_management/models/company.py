...
class Company(models.Model):
    ...
    # One2many relationship to 'internship'
    # internship_ids = fields.One2many(
    #     comodel_name='internship.management',  # Trỏ đến mô hình `internship`
    #     inverse_name='business_id',  # Tên trường Many2one trong mô hình `internship`
    #     string='Internships'
    # )
